...
namespace WindowClicker.Test
{
	...
	public class SerializerTests
	{
		...
		{
			var serializer = new DataContractJsonSerializer(typeof(Concrete));
		...
		public void DataContractJsonSerializer_Serialize()
		{
			...
			var serializer = new DataContractJsonSerializer(typeof(Concrete));
			IAbstract test = new Concrete { Name = "Test", Inner = new Inner { Name = "Test" } };
			string actual = null;
		...
		public void DataContractJsonSerializer_SerializeAndDeserialize()
		{
			// By default this serializer will write type info which is noisy.
			var serializer = new DataContractJsonSerializer(typeof(Concrete));
			IAbstract test = new Concrete { Name = "Concrete", Inner = new Inner { Name = "Test" } };
			string json = null;
